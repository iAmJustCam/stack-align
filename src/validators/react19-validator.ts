 ...
 */
function extractHookContext(sourceFile: SourceFile, filePath: string): any {
  const context: any = {
    filePath,
    isHook: false,
    name: '',
 ...
 */
function validateHooks(component: any, filePath: string): ValidationIssue[] {
  const issues: ValidationIssue[] = [];
 ...
 */
function validateReactFC(component: any, filePath: string): ValidationIssue[] {
  const issues: ValidationIssue[] = [];
 ...
 */
function validateHookNaming(hook: any, filePath: string): ValidationIssue[] {
  const issues: ValidationIssue[] = [];
 ...
 */
function validateHookReturn(hook: any, filePath: string): ValidationIssue[] {
  const issues: ValidationIssue[] = [];
